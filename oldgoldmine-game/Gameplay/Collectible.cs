...
namespace OldGoldMine.Gameplay
{
    public class Collectible : GameObject3D
    {
        ...
        /// <summary>
        /// Default construction of an empty Collectible object, provided
        ...
        /// <summary>
        /// Construct a Collectible object with a 3D model and the provided hitbox.
        /// </summary>
        /// <param name="model">The 3D model for this Collectible object.</param>
        ...
        /// <summary>
        /// Construct a Collectible object with a 3D model and create its hitbox "in place" using the specified size.
        /// </summary>
        /// <param name="model">The 3D model for this Collectible object.</param>
        /// <param name="position">Position of the object in world space.</param>
        /// <param name="scale">Scale applied to the model and hitbox.</param>
        ...
        /// <summary>
        /// Construct a Collectible object with a 3D model and an automatically generated hitbox.
        /// </summary>
        /// <param name="model">The 3D model for this Collectible object.</param>
        /// <param name="position">Position of the object in world space.</param>
        /// <param name="scale">Scale applied to the model and hitbox.</param>
        ...
        public void Update(in GameTime gameTime, in Player player)
        {
            ...
            // Gold collectibles rotate around
